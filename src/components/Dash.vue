  ...
  <div class="wrapper">
    <header class="main-header">
      <a href="/" class="logo">
        ...
        <span class="logo-mini"><img src="/static/img/canada.svg" alt="Logo" class="img-responsive center-block"></span>
        <!-- logo for regular state and mobile devices -->
        <div class="container logo-lg">
          <div class="pull-left image"><img src="/static/img/canada.svg" alt="Logo" class="img-responsive" style="height:50px;"></div>
          <div class="pull-left info">Arctic Help</div>
        </div>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/maps"><i class="fa fa-table"></i><span class="page">Maps</span></router-link></li>
